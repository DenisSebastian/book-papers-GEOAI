...
| Elemento | Detalle |
|---|---|
| **Referencia corta** | Ren et al. (2025) — *Clustering Embedding Projections* |
...
| Aspecto | Evaluación |
|---|---|
| Exploración territorial con embeddings | Alta: útil para explorar grandes colecciones de embeddings (p.ej., parches de imágenes satelitales de Chile, POIs, textos de denuncias o catastros), proyectarlas a 2D y generar regiones/etiquetas rápidamente para análisis exploratorio. |
